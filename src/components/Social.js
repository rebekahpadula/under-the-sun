    ...
    return (
        <Social>
            ...
            <SocialIconsList>
                ...
                <SocialIconsItem><SocialIconsLink target="_blank" href="https://www.youtube.com/channel/UCxvOJnlOa_gegYWQFUpmeUw"><SocialIconsImage src={youtubeIcon}/></SocialIconsLink></SocialIconsItem>
            </SocialIconsList>
        </Social>
    )
}